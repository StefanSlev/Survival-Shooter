...
const GameAction GameInput::leaderboardAction = { XINPUT_GAMEPAD_START, VK_SPACE };
...
bool GameInput::CheckLeaderboardToggle() const
{
	return this->CheckAction(leaderboardAction);
}
