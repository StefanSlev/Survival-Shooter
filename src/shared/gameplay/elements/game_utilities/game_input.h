...
private:
	...
	static const GameAction pauseAction;
	static const GameAction cameraToggleAction;
	static const GameAction resetAction;
	static const GameAction saveGameAction;
	static const GameAction loadGameAction;
